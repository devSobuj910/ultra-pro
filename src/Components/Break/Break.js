...
const Break = ({ cart }) => {
  ...
  return (
    <div>
      <div>
        <h5 className="p-2">sobuj hasan</h5>
        <div className="d-flex bg-light justify-content-between">
          <p className="p-3 m-1 w-20">
            54kg <span>Weight</span>
          </p>
          <p className="p-3 m-1 w-20">
            5'2 <span>Height</span>
          </p>
          <p className="p-3 m-1 w-20">
            26 <span>Age</span>{" "}
          </p>
      ...
      <div className="mb-5 p-3">
        ...
        <button
          id="10"
          className="p-2 m-1 border-0 rounded-circle"
          onClick={breaktimeSet}
        >
          10s
        </button>
        <button
